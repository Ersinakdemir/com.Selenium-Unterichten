...
public class c04_YanlisEmailTest {
    /*
...
Email kutusuna @isareti olmayan bir mail yazip enter’a bastigimizda “Invalid email address” uyarisi ciktigini test edelim
    ...
    public void test01(){
        ...
        mailKutusu.sendKeys("Ersingmail.com"+ Keys.ENTER);

        WebElement uyaruYazisiElementi = driver.findElement(By.xpath("//*[text()='Invalid email address.']"));
        Assert.assertTrue(uyaruYazisiElementi.isDisplayed());
